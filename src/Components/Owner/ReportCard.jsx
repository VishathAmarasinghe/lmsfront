...
const ReportCard = ({keyValue,downloadReport,titleName,index,progressReport,teacherPaymentData}) => {
  ...
  return (
    <div className='w-full flex flex-row bg-gray-200 p-2 rounded-lg mb-2'>
         <ProgressReportModel teacherPaymentData={teacherPaymentData} keyValue={keyValue} progressReport={progressReport}  progressReportModelOpen={progressReportModelOpen} setProgressReportModelOpen={setProgressReportModelOpen}/>
                <div className='w-[5%] '>
                ...
                <div className='w-[40%] flex flex-row justify-center items-center '>
                    ...
                    <Tag onClick={handleDownloadReport}  className='w-[45%] text-center bg-green-600 text-white font-medium hover:bg-green-700 scalar-card'>Download</Tag>
                </div>
            </div>   
  )
}
