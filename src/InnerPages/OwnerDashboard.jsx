...
import { getLastSevenDaysAttendance, getLastThirtyDaysclassPayment, getProgressReport, getTotalFeePaymentStatistics } from "../API";
            ...
            <div className="w-full mt-3  h-full flex flex-col justify-between">
              ...
              <div className="w-full  flex flex-row justify-between  h-[50%]">
                ...
                <div className="w-[25%] scalar-card rounded-xl shadow-lg ring-2  flex flex-col h-full  bg-white items-center justify-center">
                  <Statistic valueStyle={{fontSize:"60px",color:"#4551A1"}}   className="text-center  text-[25px] " title={<p className="text-[17px] font-medium text-center text-gray-500">Total Revenue</p>} value={reportData?.currentTotalFee} formatter={formatter}/>
                </div>
